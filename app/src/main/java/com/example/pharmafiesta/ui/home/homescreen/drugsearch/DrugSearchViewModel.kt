...
private const val TAG = "DrugSearchViewModel"

@HiltViewModel
class DrugSearchViewModel @Inject constructor( val application: Application, private val drugsDatabase: DrugsDatabase): ViewModel() {
